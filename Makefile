...
LDFLAGS=-ldflags "-X github.com/somaz94/helm-chart-kit/cmd/cli.Version=$(VERSION) -X github.com/somaz94/helm-chart-kit/cmd/cli.GitCommit=$(GIT_COMMIT) -X github.com/somaz94/helm-chart-kit/cmd/cli.BuildDate=$(BUILD_DATE)"
