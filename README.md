...
| | `helm create` | `hck` |
|---|---|---|
| **Resources it can emit** | 6, fixed | 37, composable |
...
hck list resources                         # 37 resources, grouped by purpose
...
| `HCK039` | warn | Chart creates a SecretStore its own ExternalSecret does not use |
